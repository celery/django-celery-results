...
class TaskResult(models.Model):
    ...
    task_args = models.TextField(
        ...
        help_text=_("JSON representation of the positional arguments " "used with the task"),
    )
    ...
    meta = models.TextField(
        ...
        help_text=_("JSON meta information about the task, " "such as information on child tasks"),
    )
...
class ChordCounter(models.Model):
    ...
    sub_tasks = models.TextField(
        help_text=_("JSON serialized list of task result tuples. " "use .group_result() to decode")
    )
    count = models.PositiveIntegerField(
        help_text=_("Starts at len(chord header) and decrements after each task is " "finished")
    )
