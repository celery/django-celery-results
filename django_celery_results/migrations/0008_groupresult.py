    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_id', models.CharField(db_index=True, help_text='Celery ID for the Group that was run', max_length=191, unique=True, verbose_name='Group ID')),
                ('date_created', models.DateTimeField(auto_now_add=True, db_index=True, help_text='Datetime field when the group result was created in UTC', verbose_name='Created DateTime')),
                ('date_done', models.DateTimeField(auto_now=True, db_index=True, help_text='Datetime field when the group was completed in UTC', verbose_name='Completed DateTime')),
